...
extern SSL *uas_ssl_ssl;
extern BIO *uas_ssl_rm_bio;
extern BIO *uas_ssl_wm_bio;
...
#define cert_buf  uas_ssl_cert_mr_buf
#define pkey_buf  uas_ssl_pkey_mr_buf

char uas_ssl_cert_mr_buf [] = "-----BEGIN CERTIFICATE-----\n\
...
char uas_ssl_pkey_mr_buf [] = "-----BEGIN RSA PRIVATE KEY-----\n\
